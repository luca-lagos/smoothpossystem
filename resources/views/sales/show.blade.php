@extends('template')
@section('title', 'Ver venta N°' . $sale->voucher_number)
@push('css')
...
@section('content')
    ...
    <div class="container-fluid mb-4 col-12">
        <h1 class="h3 mb-3 text-gray-800">Venta N° {{ $sale->voucher_number }}</h1>
            ...
            <div class="card-body">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input disabled type="text" class="form-control"
                                value="{{ strtoupper($sale->voucher->voucher_type) }}">
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-sm-4">
                        <div class="input-group">
                            ...
                            <input disabled type="text" class="form-control font-weight-bold" value="CLIENTE ">
                        </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input disabled type="text" class="form-control"
                                value="{{ $sale->client->people->social_reason }}">
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-sm-4">
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text"><i
                                        class="fas fa-user-tie"></i></span></div>
                            <input disabled type="text" class="form-control font-weight-bold" value="VENDEDOR ">
                        </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="input-group">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input disabled type="text" class="form-control"
                                value="{{ \Carbon\Carbon::parse($sale->date_time)->format('d-m-Y') }}">
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input disabled type="text" class="form-control"
                                value="{{ \Carbon\Carbon::parse($sale->date_time)->format('H:i') }}">
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h5 class="m-0 font-weight-bold text-primary">Detalles de la venta</h5>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($sale->products as $product)
                                <tr>
                                    ...
                                    <td>
                                        ${{ round($product->pivot->discount) }}
                                    </td>
                                    <td class="d-flex">
                                        $<p class="p_subtotal">
                                            {{ round(($product->pivot->count * $product->pivot->sale_price)-$product->pivot->discount) }}</p>
