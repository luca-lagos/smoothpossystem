...
@section('content')
    <div class="container-fluid mb-4">
        <h1 class="h3 mb-3 text-gray-800">Editar marca</h1>
            ...
            <form action="{{ route('brands.update',['brand' => $brand]) }}" method="post">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Ingrese un nombre" value="{{old('name',$brand->characteristic->name)}}">
                        @error('name')
                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <textarea name="description" id="description" rows="10" class="form-control">{{old('description',$brand->characteristic->description)}}</textarea>
                        @error('description')
                            <small class="text-danger">{{'* '.$message}}</small>
                        @enderror
                    </div>
