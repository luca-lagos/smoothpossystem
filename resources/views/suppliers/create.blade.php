...
@section('content')
    <div class="container-fluid mb-4">
        <h1 class="h3 mb-3 text-gray-800">Crear proveedor</h1>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <select name="person_type" id="person_type" class="selectpicker form-control show-tick dropdown"
                            ...
                            title="Elija el tipo de proveedor">
                            <option value="fisica" {{ old('person_type') == 'fisica' ? 'selected' : '' }}>Proveedor físico
                            </option>
                            <option value="juridica" {{ old('person_type') == 'juridica' ? 'selected' : '' }}>Proveedor
                                jurídico</option>
                        </select>
                        @error('person_type')
