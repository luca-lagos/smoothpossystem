            ...
            <form action="{{ route('clients.update', ['client' => $client]) }}" method="post">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input disabled type="text" name="person_type" id="person_type" class="form-control font-weight-bold"
                                value="{{ old('person_type', strtoupper($client->people->person_type)) }}">
                        </div>
                        @error('person_type')
                    ...
                    <div id="box_social_reason" class="col-md-4">
                        @if ($client->people->person_type == 'fisica')
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="social_reason" id="social_reason" class="form-control"
                                ...
                                value="{{ old('social_reason', $client->people->social_reason) }}">
                        </div>
                        @error('social_reason')
                            <small class="text-danger">{{ '* ' . $message }}</small>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="location" id="location" class="form-control"
                                placeholder="Ingrese la dirección" value="{{ old('location', $client->people->location) }}">
                        </div>
                        @error('location')
                            <small class="text-danger">{{ '* ' . $message }}</small>
                        @enderror
                    ...
                    <div class="col-md-4 mt-3">
                        ...
                        <select name="document_id" id="document_id" class="selectpicker form-control show-tick dropdown"
                            ...
                            @foreach ($documents as $document)
                                @if ($client->people->document_id == $document->id)
                    ...
                    <div class="col-md-4 mt-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="any" name="document_number" id="document_number"
                                ...
                                value="{{ old('document_number', $client->people->document_number) }}">
                        </div>
